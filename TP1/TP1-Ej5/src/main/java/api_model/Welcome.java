...
public class Welcome {
    ...
    public String toString() {
        ...
        return "Informe de : "+name+"\n{" +
                ...
                "\n\tTemperatura = " + df.format(main.getTemp()-273.15)+"°C | Sensasión térmica:" + df.format(main.getFeelsLike()-275.15) +
                "\n\tMínima y Máxima = " +df.format(main.getTempMin()-273.15) + "°C | " + df.format(main.getTempMax()-273.15)+" °C" +
